...
<template>
    <AuthenticatedLayout>
        ...
        <Head title="Dyeing Ironing Dashboard" />
        <div class="p-6 max-w-7xl mx-auto">
            <div class="flex justify-between items-center mb-6">
                <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Dyeing Ironing Dashboard</h1>
                <div class="flex gap-3">
                    <Link :href="route('man.staff.dyeing-ironing.page')"
            ...
            <div
                ...
                <div class="px-6 py-4 border-b border-gray-100 dark:border-zinc-800 bg-gray-50 dark:bg-zinc-800/50">
                    <h2 class="text-lg font-bold text-gray-900 dark:text-white">Recent Ironing Jobs</h2>
                </div>
                        ...
                        <tbody class="divide-y divide-gray-100 dark:divide-zinc-800">
                            <tr v-for="job in recentJobs" :key="job.id">
                                ...
                                <td class="px-6 py-4 text-gray-600 dark:text-gray-300">{{
                                    job.squeezer_job?.softener_job?.fabric?.code || 'N/A' }}</td>
